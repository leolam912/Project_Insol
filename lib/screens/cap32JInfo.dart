...
import 'package:project_bo/data/ordinanceCap32J.dart';
...
class Cap32JInfo extends StatefulWidget {
  const Cap32JInfo({Key key}) : super(key: key);

  @override
  State<Cap32JInfo> createState() => _Cap32JInfoState();
}

class _Cap32JInfoState extends State<Cap32JInfo> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        isEng?'Companies (Reports on Conduct':'公司(董事行為操守報告)規例',
                        style: TextStyle(
                          fontSize: 15,
                          color: color.AppColor.secondPageTitleColor,
                        ),
  ...
  void searchBook(String query) {
    final sections = all32Jsections.where((u) {
