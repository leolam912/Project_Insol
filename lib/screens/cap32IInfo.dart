...
import 'package:project_bo/data/ordinanceCap32I.dart';
...
class Cap32IInfo extends StatefulWidget {
  const Cap32IInfo({Key key}) : super(key: key);

  @override
  State<Cap32IInfo> createState() => _Cap32IInfoState();
}

class _Cap32IInfoState extends State<Cap32IInfo> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                       isEng?'Companies (Disqualification Order)':'公司(取消資格令)規例',
                        style: TextStyle(
                          fontSize: 15,
                          color: color.AppColor.secondPageTitleColor,
                        ),
  ...
  void searchBook(String query) {
    final sections = all32Isections.where((u) {
