...
import 'package:project_bo/data/ordinanceCap6E.dart';
...
class Cap6EInfo extends StatefulWidget {
  const Cap6EInfo({Key key}) : super(key: key);

  @override
  State<Cap6EInfo> createState() => _Cap6EInfoState();
}

class _Cap6EInfoState extends State<Cap6EInfo> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        isEng?'Proof of Debts Rules':'債權證明規則',
                        style: TextStyle(
                          fontSize: 18,
                          color: color.AppColor.secondPageTitleColor,
                        ),
  ...
  void searchBook(String query) {
    final sections = all6Esections.where((u) {
