...
import 'package:project_bo/data/ordinanceCap32C.dart';
...
class Cap32CInfo extends StatefulWidget {
  const Cap32CInfo({Key key}) : super(key: key);

  @override
  State<Cap32CInfo> createState() => _Cap32CInfoState();
}

class _Cap32CInfoState extends State<Cap32CInfo> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        isEng?'Companies (Fees and percentages)':'公司(費用及百分率)令',
                        style: TextStyle(
                          fontSize: 15,
                          color: color.AppColor.secondPageTitleColor,
                        ),
  ...
  void searchBook(String query) {
    final sections = all32Csections.where((u) {
