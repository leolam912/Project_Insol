...
class quizSection6ANoScreen extends StatefulWidget {
  String dropdownValueFrom, dropdownValueTo;
  quizSection6ANoScreen({Key key,this.dropdownValueFrom,this.dropdownValueTo}) : super(key: key);


  @override
  State<quizSection6ANoScreen> createState() => _quizSection6ANoScreenState();
}

class _quizSection6ANoScreenState extends State<quizSection6ANoScreen> {
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              isShowAns?all6Asections[_questionIndex].sectionNameEng as String:"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
