...
import 'package:project_bo/data/ordinanceCap32H.dart';
...
class Cap32HInfo extends StatefulWidget {
  const Cap32HInfo({Key key}) : super(key: key);

  @override
  State<Cap32HInfo> createState() => _Cap32HInfoState();
}

class _Cap32HInfoState extends State<Cap32HInfo> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        isEng?'Companies (Winding-up) Rules':'公司(清盤)規則',
                        style: TextStyle(
                          fontSize: 15,
                          color: color.AppColor.secondPageTitleColor,
                        ),
  ...
  void searchBook(String query) {
    final sections = all32Hsections.where((u) {
