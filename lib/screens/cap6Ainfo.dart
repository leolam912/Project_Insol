...
class Cap6AInfo extends StatefulWidget {
  const Cap6AInfo({Key key}) : super(key: key);

  @override
  State<Cap6AInfo> createState() => _Cap6AInfoState();
}

class _Cap6AInfoState extends State<Cap6AInfo> {
  ...
  void searchBook(String query) {
    final sections = all6Asections.where((u) {
