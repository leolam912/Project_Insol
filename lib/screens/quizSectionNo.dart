...
class quizSectionNoScreen extends StatefulWidget {
  String dropdownValueFrom, dropdownValueTo;
  quizSectionNoScreen({Key key,this.dropdownValueFrom,this.dropdownValueTo}) : super(key: key);


  @override
  State<quizSectionNoScreen> createState() => _quizSectionNoScreenState();
}

class _quizSectionNoScreenState extends State<quizSectionNoScreen> {
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              isShowAns?allsections[_questionIndex].sectionNameEng as String:"",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                        ...
                        children: [
                          ...
                          RichText(
                            text: TextSpan(
                              children: <TextSpan>[
                                TextSpan(
                                  text: isShowAns?allsections[_questionIndex].cue1red as String:'',
                                  style: TextStyle(
                                ...
                                TextSpan(
                                  text: isShowAns?allsections[_questionIndex].cue2 as String:'',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20,
                                  ),
                                ...
                                TextSpan(
                                  text: isShowAns?allsections[_questionIndex].cue3red as String:'',
                                  style: TextStyle(
                                    color: Colors.redAccent,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                                ...
                                TextSpan(
                                  text: isShowAns?allsections[_questionIndex].cue4 as String:'',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20,
                                  ),
                                ...
                                TextSpan(
                                  text: isShowAns?allsections[_questionIndex].cue5red as String:'',
                                  style: TextStyle(
                                    color: Colors.redAccent,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                                ...
                                TextSpan(
                                  text: isShowAns?allsections[_questionIndex].cue6 as String:'',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 20,
                                  ),
