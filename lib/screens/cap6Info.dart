...
class Cap6Info extends StatefulWidget {
  const Cap6Info({Key key}) : super(key: key);

  @override
  State<Cap6Info> createState() => _Cap6InfoState();
}

class _Cap6InfoState extends State<Cap6Info> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        isEng?'Bankruptcy Ordinance':'破產條例',
                        style: TextStyle(
                          fontSize: 18,
                          color: color.AppColor.secondPageTitleColor,
                        ),
  ...
  void searchBook(String query) {
    final sections = allsections.where((u) {
