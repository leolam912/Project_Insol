...
import 'package:project_bo/data/ordinanceCap6C.dart';
...
class Cap6CInfo extends StatefulWidget {
  const Cap6CInfo({Key key}) : super(key: key);

  @override
  State<Cap6CInfo> createState() => _Cap6CInfoState();
}

class _Cap6CInfoState extends State<Cap6CInfo> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        isEng?'Bankruptcy (Fees and Percentages) Order':'破產(費用及百分率)令',
                        style: TextStyle(
                          fontSize: 15,
                          color: color.AppColor.secondPageTitleColor,
                        ),
  ...
  void searchBook(String query) {
    final sections = all6Csections.where((u) {
